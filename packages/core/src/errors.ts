...
export const AppErrorCode = {
  ...
  ISSUE_DEPENDENCY_CYCLE: "ISSUE_DEPENDENCY_CYCLE",
  ...
  RUN_PREVIEW_STALE: "RUN_PREVIEW_STALE",
  RUN_WORK_CONTEXT_TOO_LARGE: "RUN_WORK_CONTEXT_TOO_LARGE",
  RUN_TRANSITION_INVALID: "RUN_TRANSITION_INVALID",
  RUN_ACTION_UNAVAILABLE: "RUN_ACTION_UNAVAILABLE",
  CYCLE_NOT_FOUND: "CYCLE_NOT_FOUND",
  SAVED_VIEW_NOT_FOUND: "SAVED_VIEW_NOT_FOUND",
  SAVED_VIEW_NAME_TAKEN: "SAVED_VIEW_NAME_TAKEN",
